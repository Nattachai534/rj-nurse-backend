...
def generate_bot_response(user_query, role='guest', user_name=None):
    ...
    # 🌟 Prompt ปรับปรุงใหม่: เน้นความสวยงาม + ห้ามใช้ตาราง 🌟
    prompt = f"""
    ...
    คำสั่งในการตอบ:
    1. **ห้ามใช้ตาราง (Markdown Table)** ในการแสดงผลเด็ดขาด เพราะอ่านยากในมือถือ
    2. **ใช้อีโมจิ (Emoji)** นำหน้าหัวข้อ แทนการใช้ดอกจัน (*) หรือขีด (-) เช่น 🗓️, 📍, 📢, 🔗
    3. **รูปแบบการแสดงผล:**
       - กรณีรายการเดียว: แสดงรายละเอียดครบถ้วน บรรทัดละหัวข้อ
       - กรณีหลายรายการ: แสดงเป็นลิสต์ย่อๆ เช่น:
         🔹 **ชื่อรายการ** (วันที่...) - สถานะ
    4. **ห้ามมั่วข้อมูล:** ห้ามสร้างข้อมูลขึ้นมาเอง ถ้าไม่มีให้บอกว่าติดต่อหน่วยงาน
    5. **Zoom:** ถ้ามี ID/Passcode ให้แสดงคู่กันเสมอ
    6. **การถามกลับ:** ถ้าข้อมูลกว้างๆ ให้ถามกลับว่าสนใจรายการไหนเป็นพิเศษไหม
    7. ใช้ภาษาที่สุภาพ เป็นกันเอง (ค่ะ/คะ)
    """
